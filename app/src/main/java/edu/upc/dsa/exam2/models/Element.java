package edu.upc.dsa.exam2.models;
...
public class Element {
    ...
    public String toString() {
        return "Element{" +
                ...
                ", fax=" + fax +
                ", horaris='" + horaris + '\'' +
                ", relMunicipis=" + relMunicipis +
                ", relTemes=" + relTemes +
                ", tags=" + tags +
                ", categoria=" + categoria +
                ", relComarca=" + relComarca +
                ", idSecundari='" + idSecundari + '\'' +
                ", cercadorCodi='" + cercadorCodi + '\'' +
                ", director='" + director + '\'' +
                ", xarxesSocials=" + xarxesSocials +
                ", urlRelacionades=" + urlRelacionades +
                ", iniciHorariHivern='" + iniciHorariHivern + '\'' +
                ", iniciHorariEstiu='" + iniciHorariEstiu + '\'' +
                '}';
    }
